...
//   this.setAliveStatus(false,true,false,false)
  ...
  //     this.dailyAlive=this.getDailyAliveStatus();
  //      TimerObservable.create(this.interval)
  //        .takeWhile(() => this.dailyAlive)
  //        .subscribe(() => {
  //   //         this.dailyAlive=this.getDailyAliveStatus();
  //            this._stockService.currentStock.subscribe(searchString => {
  //              this._stockService.getDailyStockPrice(searchString)
  //                .subscribe(data => {
  //
  ...
  //
  //                  console.log("In the daily observable and daily alive is ", this.dailyAlive)
  //

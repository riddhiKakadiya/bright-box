...
exports.userupdate = async function(req, res, next) {
    ...
    try {
        ...
        return res.status(400).json({status: 400, message: "user update was Unsuccesfull"})
    }
...
exports.getsortedusers = async function(req, res, next) {
        ...
        try{
            ...
            return res.status(200).json({status: 200, data: userall, message: "Succesfully users sorted"});
        }
        catch(e){

            //Return an Error Response Message with Code and the Error Message.

            return res.status(400).json({status: 400, message: "user sort was Unsuccesfull"})
        }
